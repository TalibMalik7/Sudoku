...
public class Sudoku extends javax.swing.JFrame {
    ...
    public void startGame(){
        ...
        initialiseInputs();
        createGrid();
        numberInputs[0].setBackground(Color.red);
        printInitialGrid();
    ...
    public void printInitialGrid(){
        for(int i=0;i<9;i++){
            for(int j=0;j<9;j++){
                JButton curr = boardInputs[i][j];
                if(board[i][j]==0){
                    curr.setBackground(Color.white);
                }
                else{
                    int num = board[i][j];
                    curr.setText(Integer.toString(num));
    ...
    public void selectnumber(int num){
        int prev = currNum;
       JButton prevSelected = numberInputs[prev-1];
       prevSelected.setBackground(new Color(255,255,153));
        JButton currSelected = numberInputs[num-1];
        currSelected.setBackground(Color.red);
        currNum = num;
    }
    /**
    ...
    private void initComponents() {
        ...
        i2.setBackground(new java.awt.Color(255, 255, 153));
        ...
        i3.setBackground(new java.awt.Color(255, 255, 153));
        ...
        i1.setBackground(new java.awt.Color(255, 255, 153));
        ...
        i5.setBackground(new java.awt.Color(255, 255, 153));
        ...
        i6.setBackground(new java.awt.Color(255, 255, 153));
        ...
        i7.setBackground(new java.awt.Color(255, 255, 153));
        ...
        i8.setBackground(new java.awt.Color(255, 255, 153));
        ...
        i9.setBackground(new java.awt.Color(255, 255, 153));
        ...
        jButton4.setText("Display Solution");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(int i=0;i<9;i++){
            for(int j=0;j<9;j++){
               if(board[i][j]==0){
                   JButton curr_button = boardInputs[i][j];
                   if(!curr_button.getText().isEmpty()){
                       int num = Integer.parseInt(curr_button.getText());
                       if(num== solution[i][j]) curr_button.setBackground(Color.green);
                       else curr_button.setBackground(Color.red);
                   }
               } 
            }
        }
